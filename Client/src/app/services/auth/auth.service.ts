...
export class AuthService {
  ...
  registerAdmin(
    ...
    this.http
      ...
      .subscribe(
        ...
        (error) => {
          const error_msg = this.translate.instant(
            'SIGNUP.TOAST.ERROR_MESSAGE'
          );
  ...
  login(email: string, password: string) {
    this.http.post(this.uri + 'login', { email, password }).subscribe(
      (resp: any) => {
  ...
  createMultipleUsers(params: any, flow_id: string): Observable<any> {
    return this.http.post(this.uri + 'registerMultiple/' + flow_id, params);
  }
