...
export class RegisterAdminComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this.authService.registerAdmin(this.signupForm.value.email, this.signupForm.value.password, this.signupForm.value.name, this.signupForm.value.lastName, 'admin');
  }
}
